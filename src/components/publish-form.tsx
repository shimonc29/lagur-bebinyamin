...
export function PublishForm() {
  ...
  if (status === "success") {
    return <div className="form-success"><strong>המודעה התקבלה.</strong><p>נבדוק אותה ונשלח אליכם עדכון לאחר האישור.</p></div>;
  }
  ...
  return (
    <form className="form-card" action={submit}>
      ...
      {status === "error" && <p className="form-error">לא הצלחנו לשמור את המודעה. בדקו את הפרטים ונסו שוב.</p>}
