...
export const demoListings: ListingSummary[] = [
  ...
  { id: "demo-neria", slug: "house-5-neria", title: "בית משפחתי עם חצר בנריה", locality: "נריה", propertyType: "house", rooms: 5, price: 5900, builtArea: 138, availableFrom: "2026-08-20", status: "active", featured: false },
];
